    ...
    <div class="game-container">
        ...
        <form method="post" action="index.php?page=jouer">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input id="pseudo" type="text" name="pseudo" required='required' placeholder="Ex : Ichigo"
                    autocomplete="off" style="width: 250px; font-size: 1.2em; border-bottom-color: #ff8c00;" />
            </div>
        ...
        <!-- liens vers le tableau des scores et les règles -->
